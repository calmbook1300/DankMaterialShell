...
var SPEC = {
    ...
    dankIslandReserveHeight: { def: 40 },
    dankIslandCompactHeight: { def: 38 },
    dankIslandOuterGap: { def: 4 },
    dankIslandHorizontalOffset: { def: 0 },
    dankIslandInteractionMode: { def: "hybrid" },
    dankIslandHoverOpenDelay: { def: 150 },
    ...
    dankIslandHomeWeatherSlot: { def: "hidden" },
    ...
    dankIslandSatelliteGap: { def: 12 },
    dankIslandSatelliteBackground: { def: false },
    dankIslandSatelliteGothCorners: { def: true },
    dankIslandSatelliteTransparency: { def: 1 },
    dankIslandSatelliteSwoopRadius: { def: 24 },
    dankIslandReducedMotion: { def: false },
    dankIslandSpringStiffness: { def: 560 },
    dankIslandSpringDamping: { def: 37 },
    dankIslandSpringMass: { def: 1 },
